# Disclaimer & Acceptable Use — tikeytaka

`tikeytaka` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`tikeytaka` is a general-purpose developer tool. Like most general-purpose tools, it
